...
export default function Footer() {
    return (
        <footer className="w-full relative z-50 bg-transparent py-8 px-6 md:px-12 lg:px-24 flex flex-col md:flex-row items-start md:items-center justify-between gap-8 text-foreground/40 text-[12px] font-mono uppercase tracking-[0.15em] mt-auto">
